...
export const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-10 flex h-screen w-72 flex-col overflow-y-hidden bg-gray-300 duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
