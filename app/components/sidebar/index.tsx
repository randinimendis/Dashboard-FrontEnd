    ...
    >
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear text-black dark:text-white">
        ...
        <nav className=" px-4 py-4 lg:mt-7 lg:px-6">
          {/*  Menu Group */}
          <div>
            <h3 className="mb-4 ml-4 text-sm font-semibold text-gray-600 dark:text-gray-400">
              MENU
            </h3>
                ...
                {(handleClick, open) => {
                  return (
                    <>
                      <Link
                        href="#"
                        className={`relative flex items-center gap-2 rounded-md px-4 py-2 duration-300 ease-in-out  ${
                      ...
                      >
                        <div>
                          <MdOutlineMedicalInformation size={22} />
                        </div>
                        Forms
                        <MdKeyboardArrowDown
                          size={25}
                      ...
                      <div
                        className={`overflow-hidden dropdown-menu ${
                          open ? "h-20 opacity-100" : "h-0 opacity-0"
                        }`}
                      >
                        <ul className="mb-4 mt-2 justify-center flex flex-col gap-3 pl-6">
                          <li>
                            <Link
                              href="/forms/form01"
                              className={`flex items-center gap-2.5 rounded-md px-4 font-medium duration-300 ease-in-out hover:text-gray-500 ${
                                pathname === "/forms/form01" && "text-cyan-500"
                              }`}
                            >
                              Form one
                            </Link>
                          ...
                          <li>
                            <Link
                              href="/forms/form02"
                              className={`flex items-center gap-2.5 rounded-md px-4 font-medium duration-300 ease-in-out hover:text-gray-500 ${
                                pathname === "/forms/form02" && "text-cyan-500"
                              }`}
                            >
                              Form two
                            </Link>
